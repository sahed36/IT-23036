...
public class MathPractice {
    public static void main(String[] args) {
        ...
        double theta = sc.nextDouble(); // Use nextDouble for angles
        ...
        double P = sc.nextDouble();  // Use nextDouble for Principal
        System.out.print("Enter Annual Interest Rate (r as a decimal): ");
        double r = sc.nextDouble();  // Use nextDouble for interest rate
        System.out.print("Enter Number of Compounds per Year (n): ");
        int n = sc.nextInt();  // n can be an integer
        System.out.print("Enter Time in Years (t): ");
        double t = sc.nextDouble();  // Use nextDouble for time
        double A = P * Math.pow(1 + r / n, n * t);  // Corrected Math.pow
        ...
        double thetaPolar = Math.toDegrees(Math.atan2(y, x));  // Use atan2 for better accuracy
        ...
        sc.close(); // Corrected scanner close
    }
}
